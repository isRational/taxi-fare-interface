let taxiFareApiUrl = 'https://taxifare.lewagon.ai/predict';//'https://taxifare-z62egpaqrq-ew.a.run.app/predict'//'http://localhost:8001/predict'; // replace with your API endpoint
